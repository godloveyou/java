...
<body class="childrenBody">
		    ...
		    <tbody class="news_content">
		    	<c:forEach var="tag" items="${list}">
			    	<tr>
						...
						<td align="left">${tag.cid }</td>
						<td>${tag.cname}</td>
						<td>
							<a class="layui-btn layui-btn-mini news_edit"  href="<%=request.getContextPath()%>/boss/articleCategory/edit/${tag.cid}"><i class="iconfont icon-edit"></i> 编辑</a>
							<a class="layui-btn layui-btn-danger layui-btn-mini news_del"  data-id="${tag.cid}"><i class="layui-icon">&#xe640;</i> 删除</a>
						</td>
					</tr>
				</c:forEach>
		    </tbody>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resource/admin/js/articleCategory/list.js"></script>
</body>
</html>