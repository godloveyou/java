...
<body class="childrenBody">
		    ...
		    <tbody class="news_content">
		    	<c:forEach var="tag" items="${list}">
			    	<tr>
						...
						<td align="left">${tag.title }</td>
						<td>${tag.callbackUrl}</td>
						<td>${tag.description}</td>
						<td><fmt:formatDate value="${tag.publishDate}" pattern="yyyy-MM-dd HH:mm"/></td>
						<td>
							<a class="layui-btn layui-btn-mini news_edit"  href="<%=request.getContextPath()%>/boss/links/edit/${tag.id}"><i class="iconfont icon-edit"></i> 编辑</a>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resource/admin/js/links/list.js"></script>
</body>
</html>