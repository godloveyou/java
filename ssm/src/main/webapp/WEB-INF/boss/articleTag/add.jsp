...
<span class="layui-breadcrumb">
  ...
  <a><cite>添加新标签</cite></a>
	...
	<form class="layui-form" action="<%=request.getContextPath()%>/boss/articleTag/doAdd"  method="post">
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input newsName"  name="tagName"  id="tagname"  lay-verify="required" placeholder="标签名称">
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
	...
	<script type="text/javascript"  src="<%=request.getContextPath()%>/resource/admin/js/articleTag/add.js"></script>
</body>
</html>