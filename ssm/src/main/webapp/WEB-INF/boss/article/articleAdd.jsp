...
<!-- 		<div class="layui-form-item">
	...
	<!-- 	  <input type="hidden"  name="articleContent"  id="articleContent"> -->
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block"  id="article_content">
				<textarea class="layui-textarea layui-hide"  name="contentMd"     id="news_content"></textarea>
	...
	<script src="<%=request.getContextPath()%>/resource/admin/editormd/languages/zh-tw.js"></script>
